        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          {activeTab === "profile" && (
            <div className="space-y-6">
              ...
              {/* Account Details Form & Collaboration ID */}
              <div className="space-y-4">
                <h4 className="text-xs font-semibold text-zinc-300 uppercase tracking-wider">Account Information & Collaborator ID</h4>
                ...
                <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      readOnly
                      value={userUuid}
                      className="w-full px-3 py-2 text-xs font-mono rounded-lg bg-zinc-900 border border-zinc-700 text-emerald-300 focus:outline-none select-all"
                    />
                    <button
                      type="button"
                      onClick={() => handleCopyUuid(userUuid)}
                      className="px-3.5 py-2 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 hover:text-emerald-300 border border-emerald-500/30 text-xs font-medium flex items-center gap-1.5 transition-colors cursor-pointer shrink-0"
                  ...
                  <p className="text-[11px] text-zinc-400 leading-relaxed pt-1">
                    Notebook and note owners can invite you to collaborate by pasting this UUID or typing your email (<span className="text-zinc-300 font-mono">{user.email}</span>).
                  </p>
                </div>
              </div>
            </div>
